...
class MConstants {
    ...
    companion object {
        ...
        val SKIN_MOUNT_WIDTH = 176
        val SKIN_MOUNT_HEIGHT = 158

        val BODY_MOUNT_WIDTH = 212
        val BODY_MOUNT_HEIGHT = 135

        val MOUNT_ANIMATION_SPEED = 0.1f

        val RIDER_CENTRE_MOUNT_CENTRE_OFFSET_X = 0
        val RIDER_BOTTOM_MOUNT_TOP_OFFSET_Y = -80

        val BODY_RIDER_WIDTH = BODY_MOUNT_WIDTH
        val BODY_RIDER_HEIGHT = BODY_MOUNT_HEIGHT + RIDER_BOTTOM_MOUNT_TOP_OFFSET_Y + BODY_HUMAN_HEIGHT
